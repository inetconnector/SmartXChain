...
public class TrustWalletCompatibleWallet
{
    ...
    public static (List<string>, Key, string) GenerateWallet()
    {
        ...
        try
        {
            ...
            SaveToSecureFile("mnemonic.txt", secretWords);
            SaveToSecureFile("seed.txt", seed.ToHex());
        ...
        SaveToSecureFile("walletadresses.txt", string.Join(Environment.NewLine, WalletAddresses));
    ...
    private static void SaveToSecureFile(string fileName, string content)
    {
        try
        {
